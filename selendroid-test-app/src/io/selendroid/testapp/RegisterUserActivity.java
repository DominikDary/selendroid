...
public class RegisterUserActivity extends Activity {
  ...
  public void registerUser(View view) {
    ...
    String username =
        ((EditText) findViewById(R.id.inputUsername)).getText().toString();
    String email =
        ((EditText) findViewById(R.id.inputEmail)).getText().toString();
    String password =
        ((EditText) findViewById(R.id.inputPassword)).getText().toString();
    String name =
        ((EditText) findViewById(R.id.inputName)).getText().toString();
    boolean acceptAdds =
        ((CheckBox) findViewById(R.id.input_adds)).isChecked();
    String preferedProgrammingLanguge =
        ((Spinner) findViewById(R.id.input_preferedProgrammingLanguage))
