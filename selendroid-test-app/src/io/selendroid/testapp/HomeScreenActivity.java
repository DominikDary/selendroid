...
public class HomeScreenActivity extends Activity {
  ...
  public void displayPopupWindow(View view) {
    ...
    Button btnDismiss =
        (Button) popupView.findViewById(R.id.popup_dismiss_button);
    ...
    Button btnOpenPopup = (Button) findViewById(R.id.showPopupWindowButton);
  ...
  public void displayAndFocus(View view) {
    LinearLayout linearLayout =
        ((LinearLayout) findViewById(R.id.focusedLayout));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == R.id.menu_home) {
      ...
      return true;
    } else if (item.getItemId() == R.id.menu_web_view) {
      startActivity(new Intent(getApplicationContext(), WebViewActivity.class));
      return true;
    } else if (item.getItemId() == R.id.menu_multiple_web_views) {
      startActivity(new Intent(getApplicationContext(), MultipleWebViewsActivity.class));
      return true;
    } else if (item.getItemId() == R.id.extreem_large_view) {
      startActivity(new Intent(getApplicationContext(), ExtremLargeActivity.class));
      return true;
    } else if (item.getItemId() == R.id.menu_find_employee) {
      Intent intent = new Intent("android.intent.action.MAIN");
      intent
          .setComponent(ComponentName
                            .unflattenFromString(
                                "io.selendroid.directory/io.selendroid.directory.EmployeeDirectoy"));
  ...
  private void initExceptionTestButton() {
    Button exceptionTestButton =
        (Button) findViewById(R.id.exceptionTestButton);
  ...
  private void initExceptionTestField() {
    EditText exceptionTestField =
        (EditText) findViewById(R.id.exceptionTestField);
